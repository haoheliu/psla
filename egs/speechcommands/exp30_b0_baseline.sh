...
--exp-dir $exp_dir --n-print-steps 50 --save_model True --num-workers 8 --label-csv ./data/speechcommands_class_labels_indices.csv --n_mel_bins ${n_mel_bins} \
--n_class 35 --n-epochs ${epoch} --batch-size ${batch_size} --lr $lr --dataset ${dataset} \
--model ${model} --eff_b $eff_b --impretrain ${impretrain} --att_head ${att_head} --hop_ms ${hop_ms} --seed ${seed} --apply_zero_loss_threshold ${apply_zero_loss_threshold} --n_mel_bins ${n_mel_bins} \
