...
tr_data=./data/datafiles/nsynth_instrument_train.json
val_data=./data/datafiles/nsynth_instrument_valid.json
eval_data=./data/datafiles/nsynth_instrument_test.json
n_mel_bins=40
seed=21195
...
--freqm $freqm --timem $timem --mixup ${mixup} --bal ${bal} --lr_patience 2 --reweight_loss ${reweight_loss} --weight_func ${weight_func} --n_mel_bins ${n_mel_bins} \
